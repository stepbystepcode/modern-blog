...
const Timeline = () => {
    ...
    <div className="rounded-xl bg-white dark:bg-[#242525] p-4">
        ...
        <div className="bg-gray-200 dark:bg-[#3d3e3e] w-1 absolute left-1/20 ml-5 h-72 z-0"></div>
        <div>
        {Array(3).fill(timelist[0]).map((item, index) => {
            return (
                <div key={index} className="flex gap-3 bg-white dark:bg-[#242525] rounded-lg col-span-6 p-4">
                    <div className={`shadow-xl z-50 aspect-square mt-2 rounded-full ${index === 0 ? 'bg-blue-700 border-blue-100 w-[16px] h-[16px] ml-[-2px] border-[3px]' : 'w-3 h-3  dark:bg-[#242525] bg-white border-black dark:border-white border-2'}`}></div>
